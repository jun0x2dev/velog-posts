...
![배포 전 불안에 떠는 개발자 짤](/images/02_Back-end/test_code/deploy_anxiety.png)
*(여기에 '폭탄 해체하듯 코드를 수정하는 사람'이나 '배포 버튼 앞에서 덜덜 떠는 캐릭터' 짤을 추천합니다!)*
...
- 단위 테스트 (블라디미르 코리코프 저)
---
*(여기에 '초록색 체크 표시가 가득한 대시보드'나 '안전하게 보호되는 안전장치' 짤을 넣어 마무리하면 좋습니다!)*
